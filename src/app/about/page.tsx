...
export default function About() {
 return (
    <>
      ...
      <section className="relative py-16 md:py-28 bg-dark overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <motion.p
            ...
            className="text-base md:text-xl text-gray-300 max-w-3xl mx-auto font-light"
          >
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="group bg-white/5 backdrop-blur-sm p-4 md:p-6 rounded-xl shadow-lg text-center border border-white/10 hover:border-primary/50 transition-all"
              >
          ...
          >
            {[
              ...
              <motion.div
                ...
                variants={fadeInUp}
                whileHover={{ y: -10 }}
                className="group relative bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-lg rounded-2xl p-6 md:p-8 border border-white/10 hover:border-primary/50 transition-all duration-500 shadow-xl hover:shadow-primary/20"
              >
                ...
                <motion.div
                  animate={{ y: [0, -8, 0] }}
                  transition={{ repeat: Infinity, duration: 3, ease: 'easeInOut' }}
                  className="inline-block p-3 md:p-4 bg-primary text-white rounded-2xl mb-6 shadow-lg relative z-10"
                >
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm p-4 md:p-6 rounded-2xl border border-white/10 hover:border-primary/50 transition-all group"
              >
      ...
      {/* ===== CTA SECTION ===== */}
      <section className="relative bg-gradient-to-r from-primary to-accent text-white py-12 md:py-20 overflow-hidden">
        {/* Background floating icons */}
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            <Button
              asChild
              size="lg"
              className="group relative bg-white text-primary hover:bg-gray-100 shadow-xl hover:shadow-2xl transition-all duration-300 px-6 py-4 md:px-8 md:py-6 text-base md:text-lg font-bold rounded-full overflow-hidden"
            >
              <Link href="/contact">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="group border-2 border-white text-white hover:bg-white hover:text-primary transition-all duration-300 px-6 py-4 md:px-8 md:py-6 text-base md:text-lg font-bold rounded-full"
            >
              <Link href="/services">
                Explore Services
              </Link>
